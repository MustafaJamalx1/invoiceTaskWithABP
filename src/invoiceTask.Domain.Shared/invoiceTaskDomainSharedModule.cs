...
public class invoiceTaskDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        invoiceTaskGlobalFeatureConfigurator.Configure();
        invoiceTaskModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<invoiceTaskDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<invoiceTaskResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/invoiceTask");

            options.DefaultResourceType = typeof(invoiceTaskResource);
        ...
        {
            options.MapCodeNamespace("invoiceTask", typeof(invoiceTaskResource));
        });
    }
}
