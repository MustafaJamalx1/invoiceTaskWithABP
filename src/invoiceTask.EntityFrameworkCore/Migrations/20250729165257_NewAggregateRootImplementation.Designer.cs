...
namespace invoiceTask.Migrations
{
    ...
    [Migration("20250729165257_NewAggregateRootImplementation")]
    partial class NewAggregateRootImplementation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("invoiceTask.Entites.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("invoiceTask.Entites.InvoiceItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("invoiceTask.Entites.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("invoiceTask.Entites.ProductDiscount", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppProductDiscounts", (string)null);
                });

            modelBuilder.Entity("invoiceTask.Entites.ProductPricing", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppProductPricings", (string)null);
                });
            ...
            modelBuilder.Entity("invoiceTask.Entites.InvoiceItem", b =>
                {
                    b.HasOne("invoiceTask.Entites.Invoice", null)
                        .WithMany("InvoiceItems")
                        .HasForeignKey("InvoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("invoiceTask.Entites.Product", "product")
                        .WithMany()
            ...
            modelBuilder.Entity("invoiceTask.Entites.ProductDiscount", b =>
                {
                    b.HasOne("invoiceTask.Entites.Product", null)
                        .WithMany("Discounts")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
