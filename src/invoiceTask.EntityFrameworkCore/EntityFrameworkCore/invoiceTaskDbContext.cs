...
public class invoiceTaskDbContext :
    AbpDbContext<invoiceTaskDbContext>,
    IIdentityDbContext
{
    ...
    public invoiceTaskDbContext(DbContextOptions<invoiceTaskDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(invoiceTaskConsts.DbTablePrefix + "YourEntities", invoiceTaskConsts.DbSchema);
