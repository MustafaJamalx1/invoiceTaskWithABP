...
public class invoiceTaskEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<invoiceTaskDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
             ...
             * See also invoiceTaskDbContextFactory for EF Core tooling. */
